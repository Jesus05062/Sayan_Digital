...
class SeguridadProvider extends ChangeNotifier {
  ...
  Future<bool> arbitriosSeguridadDetalles(String contrib, String anio, String token) async{
    String tributo = '035';
  ...
  Future<bool> getArbitriosSeguridad(String contrib, String token)async{
    String tributo = '035';
    ...
    if (response.body.isEmpty) {
      print("⚠️ Respuesta vacía del servidor en getArbitriosSeguridad");
      return false;
    }
    final responses = await http.get(urls, headers: headers);
