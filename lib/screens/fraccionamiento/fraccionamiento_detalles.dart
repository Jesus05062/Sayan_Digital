...
class fraccionamiento_detalles extends StatefulWidget {
  const fraccionamiento_detalles({Key? key}) : super(key: key);

  @override
  State<fraccionamiento_detalles> createState() => _fraccionamiento_detallesState();
}

class _fraccionamiento_detallesState extends State<fraccionamiento_detalles> {
  @override
  Widget build(BuildContext context) {
    final contrib = Provider.of<IngresarProvider>(context);
    final deudasProvider = Provider.of<FraccionamientoProvider>(context);
